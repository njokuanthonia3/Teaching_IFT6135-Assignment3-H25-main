...
def loss_function(recon_x, x, mu, logvar):
    ...
    kl = kl_gaussian_gaussian_analytic(
        mu_q=mu, logvar_q=logvar, mu_p=torch.zeros_like(mu), logvar_p=torch.zeros_like(logvar)
    ).sum()
...
def test():
    ...
    avg_val = validation_loss / len(test_loader.dataset)
...
if __name__ == "__main__":
    ...
    np.save('val_losses.npy',   validation_losses)
